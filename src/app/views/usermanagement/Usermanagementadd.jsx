...
const Usermanagementadd = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (formdata.roles !== 'Super Admin' && formdata.roles !== 'Admin') {
            formData.append('companyId', cmpnyOpt[0]?.id)
        }
    ...
    function changeCompanyDropdown(type, e) {
        if (e) {
            var value = e.label
        } else {
            var value = ''
                                                    ...
                                                    {(formdata.roles === 'Company Admin' || formdata.roles === 'Company User' || formdata.roles === 'Shareholder') ||
                                                        ...
                                                        <>
                                                            ...
                                                            <AutoComplete
                                                                ...
                                                                defaultValue={(userRole === 'Company User' || userRole === 'Company Admin') ? companyoptions[0] : null}
                                                                onChange={(event, value) => changeCompanyDropdown('companyName', value)}
