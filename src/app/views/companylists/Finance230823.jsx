...
import { getSortMonths, yearopt, thousandsOf, DataFormater } from '../../services/CommonObject';
                                    ...
                                    <StyledTable className="customtable odd-even withborder subtable">
                                        <TableHead>
                                            <TableRow>
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{last4Years.label}</TableCell>
                                                ))}
                                            </TableRow>
                                        </TableHead>
                                        <TableBody>
                                            <TableRow >
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.revenue)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/*  {financeByCompanyId.map((first_details, index) => (
                                            <TableCell align="left">{first_details.revenue}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow className="subrow">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.costofGoodsSold)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/* {financeByCompanyId.map((goods_details, index) => (
                                            <TableCell align="left">{goods_details.costofGoodsSold}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow >
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.grossProfit)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/*  {financeByCompanyId.map((gross_profit_details, index) => (
                                        ...
                                        {last4Years.map((last4Years, index) => (
                                            <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                last4Years.label == first_details.year ?
                                                    <span align="left"></span> : <span align="left"></span>
                                            ))}</TableCell>
                                        ))} */}
                                            {/* {financeByCompanyId.map((expenses_details, index) => (
                                            <TableCell align="left"></TableCell>
                                        ))} */}
                                            {/* </TableRow> */}
                                            {/*<TableRow className="subrow">
                                        <TableCell align="left">
                                            Marketing, Advertising & Promotier
                                        </TableCell>
                                        {financeByCompanyId.map((market_adv_details, index) => (
                                            <TableCell align="left">{market_adv_details.marketingExpense}</TableCell>
                                        ))}
                                    </TableRow>*/}
                                            <TableRow className="subrow">
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.generalAdministrative)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/* {financeByCompanyId.map((gen_adv_details, index) => (
                                            <TableCell align="left">{gen_adv_details.generalExpense}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow className="subrow">
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.interest)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/*  {financeByCompanyId.map((interest_details, index) => (
                                            <TableCell align="left">{interest_details.interest}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow >
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.generalExpense)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/* {financeByCompanyId.map((total_exp_details, index) => (
                                            <TableCell align="left">{total_exp_details.generalExpense}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow >
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.earningbeforeTaxes)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/*  {financeByCompanyId.map((before_tax_earn_details, index) => (
                                            <TableCell align="left">{before_tax_earn_details.earningbeforeTaxes}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow className="subrow">
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.taxes)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/* {financeByCompanyId.map((tax_details, index) => (
                                            <TableCell align="left">{tax_details.taxes}</TableCell>
                                        ))} */}
                                            </TableRow>
                                            <TableRow >
                                                <TableCell align="left">
                                                ...
                                                {last4Years.map((last4Years, index) => (
                                                    <TableCell>{financeByCompanyId.map((first_details, i) => (
                                                        last4Years.label == first_details.year ?
                                                            <span align="left">{getCommas(first_details.netEarning)}</span> : <span align="left"></span>
                                                    ))}</TableCell>
                                                ))}
                                                {/*  {financeByCompanyId.map((net_earning_details, index) => (
                                            <TableCell align="left"></TableCell>
                                        ))} */}
                                            </TableRow>
                                        </TableBody>
                                ...
                                <StyledCard elevation={6} className="echarts twodiv">
                                    ...
                                    <div className="datawithPercentageDiv">
                                        <div className="datawithPercentage">
                                            Gross Profit Margin<span>{ebitdamargin && ebitdamargin.grossprofitmargin ? ebitdamargin.grossprofitmargin : ''}</span>
                                        </div>
                                        <div className="datawithPercentage">
                                            EBITDA Margin<span>{ebitdamargin && ebitdamargin.ebitdaMargin ? ebitdamargin.ebitdaMargin : ''}</span>
                                        </div>
                                        <div className="datawithPercentage">
                                            Net Profit Margin<span>{ebitdamargin && ebitdamargin.netprofitMargin ? ebitdamargin.netprofitMargin : ''}</span>
                                        </div>
                                    </div>
                                </StyledCard>
                            </div>
